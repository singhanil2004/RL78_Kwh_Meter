...
#define _0CB0_TAU_TDR01_VALUE                   (0x0CB0U)   
#define _0658_TAU_TDR01_VALUE                   (0x0658U)   
/* Clock divisor for TAU0 channel 1 */
#define TAU0_CHANNEL1_DIVISOR                   (1U)        /* fCLK */

/* 16-bit timer data register 02 (TDR02) */
#define _1D4B_TAU_TDR02_VALUE                   (0x1D4BU)
/* Clock divisor for TAU0 channel 2 */
#define TAU0_CHANNEL2_DIVISOR                   (128U)      /* fCLK/2^7 24MHz */
//#define TAU0_CHANNEL2_DIVISOR                   (64U)      /* fCLK/2^6 12MHz */

#define _03A8_TAU_TDR04_VALUE                   (0x03A8U)
/* 16-bit timer data register 05 (TDR05) */
#define _15F8_TAU_TDR05_VALUE                   (0x15F8U)
/* Clock divisor for TAU0 channel 4 */
//#define TAU0_CHANNEL4_DIVISOR                   (128U)      /* fCLK/2^7 24MHz */
//#define TAU0_CHANNEL4_DIVISOR                   (64U)      /* fCLK/2^6 12MHz */
/* Clock divisor for TAU0 channel 5 */
#define TAU0_CHANNEL5_DIVISOR                   (128U)      /* fCLK/2^7 24MHz */
//#define TAU0_CHANNEL5_DIVISOR                   (64U)      /* fCLK/2^6 12MHz */
/* 16-bit timer data register 06 (TDR06) */
#define _FFFF_TAU_TDR06_VALUE                   (0xFFFFU)
/* Clock divisor for TAU0 channel 6 */
#define TAU0_CHANNEL6_DIVISOR                   (128U)      /* fCLK/2^7 24MHz */
//#define TAU0_CHANNEL6_DIVISOR                   (64U)      /* fCLK/2^6 12MHz */
/* Timer fCLK */
#define TAU0_fCLK                               (24U)       /* 24MHz */
//#define TAU0_fCLK                               (12U)       /* 12MHz */
