...
{
    BUPPRT = 1U;    /* BUPCTL0 register can be written and read */
    VBATEN = 0U;    /* power switching function stops */
    VBATEN = 1U;    /* power switching function operates */
    BUPPRT = 0U;    /* BUPCTL0 register cannot be written */
}
