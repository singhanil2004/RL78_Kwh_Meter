...
#define _00_RTC_EVENT0_DETECTED                            (0x00U) /* no event is detected */
#define _04_RTC_EVENT0_NOTDETECTED                         (0x04U) /* an event is detected */
...
/* Time Capture Status (TCST) */
#define _00_RTC_EVENT1_DETECTED                            (0x00U) /* no event is detected */
#define _04_RTC_EVENT1_NOTDETECTED                         (0x04U) /* an event is detected */
/* Time Capture Control (TCCT) */
...
/* Time Capture Status (TCST) */
#define _00_RTC_EVENT2_DETECTED                            (0x00U) /* no event is detected */
#define _04_RTC_EVENT2_NOTDETECTED                         (0x04U) /* an event is detected */
/* Time Capture Control (TCCT) */
